                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        ...
                                        Intent Z = new Intent(AdminLogin.this, AdminBottomNavigation.class);
                                        startActivity(Z);
                                        finish();

                                    }else{
                                        Reusable.ShowAlert(AdminLogin.this,"Verification Failed","You Have Not Verified Your Email");

                                    }
                                }else{
                                    mDialog.dismiss();
                                    Reusable.ShowAlert(AdminLogin.this,"Error",task.getException().getMessage());
                                }
                            }
                        });
                    }
