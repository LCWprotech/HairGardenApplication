...
public class StaffSearchAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(StaffSearchAppointment.this));
    ...
    private void showDateDialog(final EditText date_in) {
        ...
        DatePickerDialog mDatePicker = new DatePickerDialog(
                StaffSearchAppointment.this, new DatePickerDialog.OnDateSetListener() {
    ...
    private void adminAppointment() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new cusAppointmentAdapter(StaffSearchAppointment.this,AppointList);
